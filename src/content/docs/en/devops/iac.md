...
| --- | --- | --- |
| Terraform / OpenTofu | HCL (HashiCorp Configuration Language) | Most widely used. Supports every vendor. Terraform 1.16 / OpenTofu 1.12 (as of 2026) |
