...
単一ベンダーへの統合を深めるほど、**価格交渉力が低下し**、ベンダーのポリシー変更（値上げ、サービス終了、地域からの撤退）に対して脆弱になります。欧州連合のDigital Operational Resilience Act（DORA）、韓国の電子金融監督規定などは、金融業界に**Exit Planの文書化**を義務付けています。
