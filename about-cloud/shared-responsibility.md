...
"일단 되게 하자"는 마음으로 관리자 권한을 부여하고, 이후 축소하지 않는 경우가 많습니다. **최소 권한 원칙** (Principle of Least Privilege)을 적용하여, 필요한 최소한의 권한만 부여해야 합니다. 장기 자격 증명의 위험성과 역할 기반 인증에 대해서는 [IAM과 접근 제어](../security/iam.md)에서 자세히 다룹니다.
