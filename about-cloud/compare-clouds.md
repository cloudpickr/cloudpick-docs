...
| 구분 | 인증 방식 | 벤더 (2025년 기준) |
| --- | --- | --- |
| **국내 클라우드** | 등급제 아님 (단일 인증) | NCP, KT Cloud, NHN Cloud, Kakao Cloud |
| **글로벌 클라우드** | 등급제 (하 등급 취득) | AWS, Azure, GCP |

> CSAP 제도는 N2SF(국가망보안체계)로의 전환이 진행 중이며, 향후 등급 체계가 변경될 수 있습니다. 도입 시 최신 현황을 확인하세요.
