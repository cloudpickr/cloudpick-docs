...
| August 8–11, 2026 | **Second phase evaluation** conducted, covering 4 teams — LG AI Research, SK Telecom, Upstage, and Motif Technologies. Combining global benchmarks, expert review, and evaluation by a 200-person citizen panel, 3 of the 4 teams are expected to pass |

:::caution
As of this document's review date (August 9, 2026), the second phase evaluation is still underway, with results reportedly expected around August 12, 2026. Check the official announcement for the final passing and eliminated teams.
:::
...
- **A shifting vendor landscape**: the project's participants (as of August 2026: LG AI Research, SK Telecom, Upstage, and Motif Technologies) continue to be winnowed through evaluations held every six months. Rather than fully committing your architecture to any single team's long-term roadmap, maintaining a **gateway/abstraction layer that treats the FM as a swappable component** is the safer approach to risk management.
...
- **Signing long-term contracts on the assumption that the final surviving teams are already settled** — as of August 2026, the second-round evaluation is still ongoing, and the final two teams won't be confirmed until 2027. Fully subordinating procurement to a specific team's roadmap is risky.
