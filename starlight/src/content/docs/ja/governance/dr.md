...
セカンダリリージョンを選ぶ際は、レイテンシ(レプリケーション遅延)とあわせて**データが国境を越えるかどうか**を確認する必要があります。同じ国内に第2リージョンを持つベンダーであれば、データが国外に出ないDR構成が可能であり、そうでなければ最も近い隣国のリージョンが候補になります。

:::caution
国外リージョンをDR対象として使用する場合、当該国の個人情報保護法制が定めるデータの国外移転要件を満たす必要があります。データ主権が厳格なワークロードは、国内DRが可能なベンダー・リージョンの組み合わせを優先的に検討してください。国別のリージョン現況と国内DR可能な組み合わせは国別ガイドを参照してください — [韓国](../../korea/index/)など。
:::
