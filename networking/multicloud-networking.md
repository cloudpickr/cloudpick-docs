...
{% hint style="info" %}
트랜짓 아키텍처, 이그레스 비용, DNS 통합 등 심화 내용은 [멀티클라우드 네트워크 아키텍처](multicloud-connectivity.md)를 참고하세요.
{% endhint %}
...
- **각국 로컬 IX**: 국가별로 주요 CSP PoP를 모두 보유한 로컬 IX가 있는 경우가 많습니다 (예: 한국 KINX — [한국 가이드](../korea/index.md) 참고)
