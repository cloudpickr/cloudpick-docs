...
:::note
멀티 AZ까지는 **고가용성(HA)** 설계로, 멀티 리전부터는 **재해복구(DR)** 설계로 접근합니다. DR 전략 유형(Backup & Restore ~ Active-Active), RPO/RTO 정의, 벤더별 DR 서비스는 [재해복구 (DR)](../../governance/dr/)를 참고하세요.
:::
...
- [한국](../../korea/index/) — 서울·부산·춘천 리전, CSAP, 개인정보보호법
...
:::note
소버린 랜딩존의 가드레일 설계와 벤더별 구현 상세는 [랜딩존 — 소버린 랜딩존](../../governance/landing-zone/#소버린-랜딩존-sovereign-landing-zone)을 참고하세요.
:::
