...
서버(노드)를 직접 관리하지 않고 컨테이너를 실행하는 서비스입니다. AWS Fargate, Azure Container Apps, Google Cloud Cloud Run, OCI Container Instances 등이 있으며, 각 제품의 상세 비교는 [서버리스](../../compute/serverless/#서버리스-컨테이너) 문서를 참고하세요.
...
:::note
Day-2 운영 상세는 [Kubernetes 운영](../../devops/kubernetes-operations/)을 참고하세요.
:::
