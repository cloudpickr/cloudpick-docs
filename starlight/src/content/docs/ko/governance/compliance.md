...
- **한국** — ISMS-P, CSAP, 금융권 규제(전자금융감독규정·망분리): [컴플라이언스 (한국)](../../korea/governance/compliance/)
- **미국** — FedRAMP, HIPAA, ITAR/EAR: [미국 가이드](../../us/index/)
- **EU** — GDPR·데이터 주권, DORA, NIS2·EU AI Act: [EU 가이드](../../eu/index/)
- **일본** — ISMAP, APPI: [일본 가이드](../../japan/index/)
- **싱가포르** — MTCS, PDPA: [싱가포르 가이드](../../singapore/index/)
