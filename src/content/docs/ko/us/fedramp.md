...
- **현재 운영 상태(2026년 8월 기준)**: Class A 파이프라인이 8월 초 열렸고 Class B/C도 8월 말(8월 31일) 오픈되어 신규 20x 인증 접수가 시작된 과도기이며, fedramp.gov 공식 통계 기준 전체 약 529개 인가 서비스 중 약 28개가 신규 FedRAMP 20x 기준으로 인가를 받았고, 나머지 대다수는 여전히 기존 Rev5(Low/Moderate/High) 체계로 운영되고 있습니다.
