...
| **EU AI Act**（GPAI義務2025.08適用; 制裁権限・第50条の透明性2026.08発効; 高リスクAIはDigital Omnibusにより延期 — 独立型2027.12、製品内蔵2028.08） | 高リスクAIシステムのデータガバナンス → ランディングゾーンにAIワークロード別のデータ分類/アクセス制御を含む |
