...
:::note[선행 지식 및 연결 문서]
파운데이션 모델(FM)과 클라우드 AI 플랫폼 기본은 [AI 시작하기](../../ai/getting-started/)와 [AI 플랫폼과 모델 비교](../../ai/ai-ml/)를 먼저 참고하세요. 이 문서는 FM 도입 시의 1st-party(퍼스트파티) vs 3rd-party(서드파티) 모델 선택에 초점을 둡니다.
:::
