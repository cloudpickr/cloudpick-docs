...
- [Kentik Cloud Latency Map](https://www.kentik.com/labs/cloud-latency-map/) — AWS, Azure, GCP, IBM, Oracle 리전 간 지연 시간을 지속적으로 측정하여 시각화합니다. 리전 간 비교뿐 아니라 지연 시간 변화 추이까지 확인할 수 있어, 가장 종합적인 도구입니다.
...
- [CloudPing.info](https://www.cloudping.info/) — AWS를 중심으로 Azure 등 여러 클라우드의 리전별 지연 시간을 측정할 수 있습니다.
