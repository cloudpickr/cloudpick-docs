...
:::note
Government Cloud shares a similar purpose with public-sector cloud migration policies in various countries, but it differs in that provider selection is run through an annual open call and review process led by the Digital Agency rather than a single central procurement authority, and it is tightly coupled with a separate piece of legislation on local government system standardization.
:::
