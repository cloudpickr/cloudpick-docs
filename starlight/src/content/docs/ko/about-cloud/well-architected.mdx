...
3. **안정성 (Reliability)** — 장애로부터 복구하고 가용성 유지. [재해복구](../../governance/dr/) 전략과 직결됩니다.
...
<TabItem label="Google Cloud — 5개 Pillar">
...
> 📄 [공동 책임 모델](../../about-cloud/shared-responsibility/)

> 📄 [랜딩존](../../governance/landing-zone/)
