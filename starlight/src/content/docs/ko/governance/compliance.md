...
- **한국** — ISMS-P, CSAP, 금융권 규제(전자금융감독규정·망분리): [한국 부록](../../korea/index/) · [컴플라이언스 (한국)](../../korea/governance/compliance/)
- **미국** — FedRAMP, HIPAA, ITAR/EAR: [미국 개요](../../us/index/)
- **EU** — GDPR·데이터 주권, DORA, NIS2·EU AI Act: [EU 개요](../../eu/index/)
- **일본** — ISMAP, APPI: [일본 개요](../../japan/index/)
