...
- 対象ユーザーに近いリージョンを持つベンダーを優先
- グローバルサービスはエッジネットワークとリージョンカバレッジを検討
- DR時は近接リージョンまで考慮（[リージョンとアベイラビリティゾーン](../../about-cloud/regions-and-zones/)を参照）

### 3. 規制および法令遵守

- 公共・金融など規制産業は国別の認証・義務が異なる場合がある — [韓国](../../korea/) · [米国](../../us/) · [EU](../../eu/) · [日本](../../japan/) · [シンガポール](../../singapore/)
- 個人情報の国外移転、データレジデンシー要件
- 詳細は[コンプライアンス](../../governance/compliance/)を参照
...
- ローカルリージョンの価格は米国リージョンに比べて高いのが一般的（しばしば10〜30%）
- マネージドサービスのプレミアム
