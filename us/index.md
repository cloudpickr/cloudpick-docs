...
- **[주(州) 프라이버시법](state-privacy.md)** — 연방 포괄법이 없는 미국의 주별 프라이버시 규제 지형입니다. CCPA/CPRA를 중심으로 시행 주 현황, 공통 요건, 멀티스테이트 대응 아키텍처를 다룹니다.
- **[AI 정책과 거버넌스](ai-policy.md)** — 연방 AI 행정명령 흐름, NIST AI RMF, 연방 조달의 AI 요건, 주별 AI법 동향과 클라우드 AI 워크로드 시사점을 정리합니다.
