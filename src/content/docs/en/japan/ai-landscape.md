...
- **August 2026**: the domestic LLM evaluation environment is built (a stage preceding formal trial use within Gennai); whether it proceeded as planned needs further confirmation via official announcements.
