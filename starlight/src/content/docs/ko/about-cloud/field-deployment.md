...
:::note
공공·금융 비중이 큰 시장에서는 대형 SI(예: 한국의 삼성SDS·LG CNS·SK C&C)가 대규모 프로젝트에서 지배적입니다. FDE는 이들과 **경쟁이 아닌 협업** 관계가 많습니다 — SI가 전체 시스템을 구축하고, FDE는 자사 AI/SaaS 제품의 통합 파트를 담당하는 구조입니다.
:::
...
| 과제 | 설명 | 관련 문서 |
| --- | --- | --- |
| 남의 계정에서 일하기 | 고객의 AWS/Azure/GCP 계정에서 최소 권한으로 작업 | [계정과 조직 구조](../../about-cloud/accounts-and-organizations/) |
| 협상된 IAM | 고객 보안팀과 조율한 제한된 접근 권한 | [IAM 개요](../../about-cloud/iam-overview/) |
| 망분리 환경 | 에어갭, 프록시 전용, 제한된 인터넷 접근 | [망분리와 네트워크 격리](../../security/network-isolation/) |
| 원격 접근 제약 | 고객별 VPN, 배스천 호스트, 제로 트러스트 접근 | [원격 접근 관리](../../devops/remote-access/) |
| 규정 준수 | 고객의 산업별 규제 (금융: PCI-DSS, 의료: HIPAA, 공공: FedRAMP) | [규정 준수](../../governance/compliance/) |

### 인프라와 클라우드

FDE는 고객 환경에 따라 어떤 클라우드든 다룰 수 있어야 합니다.

- [클라우드 시작하기](../../about-cloud/getting-started/) — 기본 개념
- [벤더 비교하기](../../about-cloud/compare-clouds/) — 같은 기능의 벤더별 차이
- [리전과 가용영역](../../about-cloud/regions-and-zones/) — 데이터 주권, 지연 시간
- [공동 책임 모델](../../about-cloud/shared-responsibility/) — 고객 환경에서 책임 경계

### 보안과 거버넌스

고객 보안팀은 FDE에게 가장 까다로운 이해관계자입니다.

- [IAM 심화](../../security/iam/) — 크로스 어카운트, 임시 자격 증명
- [시크릿 관리](../../security/secrets/) — 고객 환경의 시크릿 접근
- [데이터 보호](../../security/data-protection/) — 고객 데이터 취급
- [제로 트러스트](../../security/zero-trust/) — 현대 엔터프라이즈 접근 모델
- [랜딩존](../../governance/landing-zone/) — 고객의 클라우드 기반 구조 이해

### 구축과 운영

FDE가 프로덕션 코드를 소유한다면, 운영도 함께 알아야 합니다.

- [DevOps 시작하기](../../devops/getting-started/) — CI/CD, 자동화
- [모니터링](../../devops/monitoring/) → [관찰가능성](../../devops/observability/) — 고객 환경 디버깅
- [SLI/SLO](../../devops/slo/) — 성공 지표 정의
- [재해복구](../../governance/dr/) — 고객 환경 장애 대응
- [보안 사고 대응](../../security/incident-response/) — 사고 시 고객과의 협업

### 데이터와 통합

고객의 데이터를 이해하고 연결하는 것이 FDE 업무의 핵심입니다.

- [데이터베이스 운영](../../database/operations/) — 고객 DB 접근과 연동
- [데이터베이스 마이그레이션](../../database/migration/) — 데이터 이관

### AI/에이전트 배포

2025-2026년 FDE 수요 폭증의 직접 원인입니다.

- [AI 시작하기](../../ai/getting-started/) — AI 제품 이해
- [RAG 고급 패턴](../../ai/rag-patterns/) — 고객 데이터 기반 RAG 구축
- [AI 에이전트](../../ai/agents/) — 에이전틱 워크플로우 배포
- [LLMOps](../../ai/llmops/) — 평가, 비용, 운영, **에이전트 관측**
- [AI 보안](../../security/ai-security/) — 가드레일, 프롬프트 인젝션 방어
