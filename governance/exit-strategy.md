...
# 벤더 종속성과 Exit Strategy

> 문서 기준: 2026년 5월

## 왜 Exit Strategy가 필요한가
...
AWS Prescriptive Guidance도 같은 입장을 명시합니다: "종속성 방지는 기술 결정보다 조직의 인력·프로세스에 더 의존합니다" ([출처](https://docs.aws.amazon.com/prescriptive-guidance/latest/strategy-multicloud-fsi/vendor-lockin.html)).
...
자세한 비교는 [IaC](../devops/iac.md)를 참고하세요.
