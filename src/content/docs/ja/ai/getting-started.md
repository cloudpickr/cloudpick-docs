...
:::note[役割別にどこから読むか]
AI導入は役割ごとに必要な情報と深さが異なります。以下はクイックな入口で、役割×成熟度（導入段階）を掛け合わせた詳細な道筋は[AIシステムライフサイクル](../../ai/lifecycle/)の導入ジャーニーマップを参照してください。

- **経営・意思決定者** — [AIプラットフォームとモデル比較](../../ai/ai-ml/)、[AIシステムライフサイクル](../../ai/lifecycle/)（何を・なぜ）
- **アーキテクト** — [AIシステムライフサイクル](../../ai/lifecycle/)、[マルチクラウドAI](../../ai/multicloud-ai/)
- **開発者** — [プロンプトエンジニアリング](../../ai/prompt-engineering/)、[RAG高度パターン](../../ai/rag-patterns/)、[AIエージェント](../../ai/agents/)
- **運用・プラットフォーム** — [LLMOps](../../ai/llmops/)、[AIセキュリティ](../../security/ai-security/)
- **調達・FinOps** — [LLMチャネル選択](../../ai/1p-vs-3p/)、[ライセンスとコスト](../../ai/licensing/)
- **ガバナンス** — [エージェント導入ガイド](../../ai/agent-adoption/)、ライフサイクルの[問題定義・ガバナンス](../../ai/lifecycle/#1-問題定義およびガバナンス-problem-framing--governance)
- **現場デプロイ（FDE）** — [現場デプロイ](../../about-cloud/field-deployment/)（顧客環境での本番デリバリー）
:::
