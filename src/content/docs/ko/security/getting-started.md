...
| 계층 | 역할 | CloudPick 문서 |
| --- | --- | --- |
| 거버넌스 & 정책 | 책임 범위, 규정 준수 | [공동 책임 모델](../../about-cloud/shared-responsibility/), [컴플라이언스](../../governance/compliance/) |
| 신원 & 접근 제어 | 누가 무엇을 할 수 있는지 | [IAM 심화](../../security/iam/), [제로 트러스트](../../security/zero-trust/) |
| 네트워크 보안 | 트래픽 격리와 필터링 | [VPC/서브넷](../../networking/vpc-subnet/) |
| 데이터 보호 | 암호화, 키 관리, DLP | [데이터 보호](../../security/data-protection/), [시크릿 관리](../../security/secrets/) |
| 탐지 & 대응 | 위협 탐지, 사고 대응 | [보안 태세 관리](../../security/security-posture/), [사고 대응](../../security/incident-response/) |
| DevSecOps | 파이프라인 보안 | [DevSecOps](../../devops/devsecops/) |
| AI 보안 | 모델/데이터 보호 | [AI 보안](../../security/ai-security/) |
