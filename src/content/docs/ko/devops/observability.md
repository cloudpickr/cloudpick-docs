...
:::note
단일 클라우드 모니터링 기초는 [모니터링](../../devops/monitoring/)을 참고하세요. SLI/SLO/SLA 개념은 [SLI/SLO와 에러 버짓](../../devops/slo/)에서 다루고 있습니다. 이 문서는 **멀티클라우드 환경에서 어떻게 관찰가능성을 통합하는가** 에 초점을 맞춥니다.
:::
...
- [ ] SLO 정의와 에러 버짓 대시보드 구성 ([SLI/SLO와 에러 버짓](../../devops/slo/) 참고)
...
- **모든 로그를 DEBUG 레벨로 중앙 플랫폼에 전송** — 수집 비용이 폭증합니다. 환경별 로그 레벨 정책(프로덕션은 WARN 이상)을 수립하세요.
...
- [모니터링](../../devops/monitoring/)
- [SLI/SLO](../../devops/slo/)
- [플랫폼 엔지니어링](../../devops/platform-engineering/)
