...
{% hint style="info" %}
배포 전 보안 검증은 [DevSecOps](../devops/devsecops.md)를, OS/런타임 패치는 [패치 관리와 취약점 대응](../devops/patch-and-vulnerability.md)을 참고하세요.
{% endhint %}
...
- **규정 준수 매핑** — CIS 항목이 ISO 27001, SOC 2, [ISMS-P](../governance/compliance.md) 통제 항목과 매핑됨
