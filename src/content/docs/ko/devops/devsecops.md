...
:::note
배포 후 운영 환경의 보안 감시는 [보안 태세 관리](../../security/security-posture/)를, OS/런타임 패치는 [패치 관리와 취약점 대응](../../devops/patch-and-vulnerability/)을 참고하세요.
:::
...
Terraform, CloudFormation, Bicep 등 [인프라 코드](../../devops/iac/)에서 보안 구성 오류를 배포 전에 탐지합니다.
...
코드 저장소에 커밋된 시크릿(API 키, 비밀번호, 토큰)을 탐지합니다. 시크릿의 안전한 저장과 교체는 [시크릿 관리](../../security/secrets/)를 참고하세요.
