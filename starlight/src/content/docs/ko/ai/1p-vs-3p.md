...
제공사별 모델 목록과 접근 가능 채널은 [AI 플랫폼과 모델 비교](../../ai/ai-ml/)를, 한국 FM 제공사(Upstage, EXAONE 등)는 [FM 제공사 비교 (한국)](../../korea/ai/fm-providers/)를 참고하세요. 패턴별 특성 비교 표는 위 **패턴별 특성 비교** 절을 사용합니다.
...
- [FM 제공사 비교 (한국)](../../korea/ai/fm-providers/) — 한국 엔터프라이즈의 요구사항별 채널 선택 가이드
