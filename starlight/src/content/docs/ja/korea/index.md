...
- **[韓国市場・インフラ現況](../korea/market/)** — ベンダー別の韓国リージョン現況、国内DR構成、データ主権（個人情報保護法・信用情報法）、専用接続PoP（KINX）、MSP・コミュニティを整理します。
...
- 国際認証・ベンダーハブについては[コンプライアンス（Compliance）](../governance/compliance/)を参照してください。
