...
| **Google Cloud** | Sovereignty partnerships (T-Systems, Thales/S3NS, Proximus) | Partner-operated regions | Germany is handled by T-Systems, France by Thales subsidiary S3NS (SecNumCloud 3.2 qualified, Dec 2025), and Belgium/Luxembourg in partnership with Proximus. In May 2026, Thales and Google Cloud announced a new sovereign cloud partnership in Germany |
