---
title: "リージョンと可用性ゾーン"
description: "リージョン、可用性ゾーン、エッジロケーションの概念と韓国リージョンの現況、DR時の近接リージョンをベンダー別に比較します。"
---
...
| 韓国リージョンペア | `koreacentral`（ソウル）↔ `koreasouth`（釜山）— 国内DRが可能 |
...
- **レイテンシ** — ユーザーに近いリージョンを選択します。韓国のユーザーが対象であれば、韓国リージョンが最善です。
...
:::note
Azure（ソウル-釜山）とOCI（ソウル-春川）は国内に2つのリージョンを保有しているため、データが国外に出ないDR構成が可能です。AWS/Google Cloudは東京・大阪が最も近いDR候補です。ベンダー別DR戦略の詳細は[災害復旧 (DR)](../../governance/dr/)を参照してください。
:::
