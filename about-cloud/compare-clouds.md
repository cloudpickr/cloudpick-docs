...
한국 공공기관에 클라우드를 도입하려면 CSAP(클라우드 보안 인증 제도) 인증 벤더를 사용해야 합니다. 2024년부터 정보시스템 중요도에 따라 상·중·하 등급제가 전면 시행되었습니다.

| 등급 | 대상 시스템 | 인증 벤더 (2025년 기준) |
| --- | --- | --- |
| **상** | 민감 정보 처리 시스템 | NCP, KT Cloud, NHN Cloud 등 국내 CSP |
| **중** | 일반 업무 시스템 | 국내 CSP |
| **하** | 중요도 낮은 시스템 | AWS, Azure, GCP (2024~2025년 취득) |

> CSAP 제도는 국정원 보안적합성 검증과의 통합, N2SF(국가망보안체계) 전환 등이 논의 중이며, 향후 변경될 수 있습니다. 도입 시 최신 현황을 확인하세요.
