...
現行のHIPAA Security Ruleは、多くの保護措置を「必須(Required)」と「推奨(Addressable、代替措置の採用可)」に区分してきました。しかしHHSは2025年1月、この区分を廃止し、大半の保護措置を義務化する改正案(NPRM)を発表しました。
