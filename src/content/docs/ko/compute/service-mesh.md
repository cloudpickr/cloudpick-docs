...
:::note[선행 지식 및 연결 문서]
이 문서는 [컨테이너 서비스](../../compute/containers/)와 [쿠버네티스 운영](../../devops/kubernetes-operations/)으로 마이크로서비스를 운영하는 환경을 전제로 합니다. 컨테이너·오케스트레이션 기본 개념은 해당 문서를 먼저 참고하세요. 이 문서는 서비스 간 통신을 인프라 계층에서 다루는 서비스 메시에 초점을 둡니다.
:::
