...
{% hint style="info" %}
계정/조직의 기본 개념, 빌링 구조, 쿼타 관리는 [계정과 조직 구조](../about-cloud/accounts-and-organizations.md)를 참고하세요. 이 문서는 그 위에 구축하는 **구현 가이드**입니다.
{% endhint %}
...
네트워크 설계 상세는 [VPC와 서브넷](../networking/vpc-subnet.md)을 참고하세요.
