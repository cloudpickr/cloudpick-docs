...
:::note[선행 지식 및 연결 문서]
트랜잭션 데이터 저장은 [관리형 RDB](../../database/managed-rdb/), [NoSQL](../../database/nosql/)을 먼저 참고하세요. 이 문서는 전문 검색·로그 분석·형태소 분석 등 검색 엔진 워크로드에 초점을 둡니다. AI 기반 시맨틱 검색은 [벡터 스토어](../../ai/vector-store/)와 연결됩니다.
:::
