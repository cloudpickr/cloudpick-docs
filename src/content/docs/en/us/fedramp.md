...
:::caution
FedRAMP 20x is an overhaul still in progress as of September 2026, and details are changing rapidly. The information below reflects what has been confirmed on the official [fedramp.gov](https://www.fedramp.gov/) pages and announcements; anyone evaluating actual adoption must re-verify the latest guidance directly on fedramp.gov.
:::
...
- **Current operational status (as of September 2026)**: This transitional period continues: the Class A pipeline opened in early August, and Classes B/C opened at the end of August (August 31), beginning to accept new 20x authorizations. Per official fedramp.gov statistics, of roughly 529 total authorized services, approximately 28 have been authorized under the new FedRAMP 20x framework (figures vary with the official portal's tally date), while the large majority still operate under the existing Rev5 (Low/Moderate/High) framework.
...
:::note
In other words, as of September 2026 the new 20x framework and the existing Rev5 framework coexist in a transitional period. Which framework a given target agency or service was authorized under must be individually verified on the [FedRAMP Marketplace](https://marketplace.fedramp.gov/).
:::
...
The CMMC final rule (32 CFR Part 170) took effect in 2024, and the amended DFARS 252.204-7021 rule incorporating it into contracts took effect on November 10, 2025. However, as of September 2026, the phased implementation schedule (following Phase 2) is understood to be temporarily on hold for review, so **the exact implementation phase must be reconfirmed at the time of contracting.**
...
- FedRAMP authorization is a de facto essential condition for entering the US federal SaaS market, and obtaining it requires significant time and cost. FedRAMP 20x is an attempt to automate and shorten this process, but as of September 2026 it remains in a transitional period, so companies entering the market should decide which framework (Rev5 vs. 20x) to pursue authorization under based on the latest guidance on fedramp.gov.
