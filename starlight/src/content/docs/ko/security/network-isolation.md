...
- **한국** — 전자금융감독규정, CSAP 상·중·하 등급, ISMS-P, N2SF(국가망보안체계) C/S/O 등급: [망분리와 네트워크 격리 (한국)](../../korea/security/network-isolation/)
...
- 한국 규제(전자금융감독규정, CSAP, N2SF) 원문 링크: [망분리와 네트워크 격리 (한국)](../../korea/security/network-isolation/)
