...
| --- | --- | --- | --- |
| **텍스트 (LLM)** | 텍스트 → 텍스트 | Bedrock(Claude Fable 5/Opus 4.8, GPT-5.5, Llama), Microsoft Foundry(GPT-5.5/5.4/5.4 mini), Vertex AI(Gemini 3.5 Pro/3.5 Flash/3.1 Pro) | 챗봇, 요약, 코드 생성 |
| **이미지 생성** | 텍스트 → 이미지 | Bedrock(Titan Image, Stable Diffusion), Microsoft Foundry(DALL-E, **MAI-Image-2.5**, **MAI-Image-2.5 Flash**), Vertex AI(Imagen) | 마케팅 소재, 디자인 프로토타입 |
