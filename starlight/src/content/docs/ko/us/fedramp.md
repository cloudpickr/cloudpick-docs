...
- **Certification Class 체계**: 기존 Low/Moderate/High를 대체하는 Class A/B/C/D 4단계 체계가 2026년 2월 25일 공개된 NTC-0004(정책 문서)에 근거해 도입되었습니다. Class C가 대체로 기존 Moderate에 해당하며, CUI 등 비공개 연방 데이터를 다루는 시스템에 적용됩니다.
