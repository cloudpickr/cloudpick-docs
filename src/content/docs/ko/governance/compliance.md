...
- **한국** — ISMS-P, CSAP, 금융·망분리, 소버린 FM: [한국 개요](../../korea/) · [컴플라이언스 (한국)](../../korea/governance/compliance/)
- **미국** — FedRAMP, HIPAA, ITAR/EAR, 주 프라이버시법, AI 정책: [미국 개요](../../us/)
- **EU** — GDPR·데이터 주권, DORA, NIS2·AI Act, 회원국 스킴, 소버린 AI: [EU 개요](../../eu/)
- **일본** — ISMAP, APPI, 가버먼트 클라우드, AI 지형: [일본 개요](../../japan/)
- **싱가포르** — MTCS, PDPA, GCC·IM8, AI 거버넌스: [싱가포르 개요](../../singapore/)
...
| **금융 (EU)** | DORA | EU | 2025.1.17 적용 개시. 2025.11.18 ESAs가 최초 CTPP(Critical Third-Party Provider) 19개 지정(AWS·Google Cloud·Microsoft 등). [상세](../../eu/dora/) |
...
- [ ] 해당 데이터에 적용되는 **법적 요건** 을 파악했는가? (대상 관할권)
...
- **인증 갱신 주기 관리** — 대부분의 인증은 3년 유효에 연 1회 사후·감시심사를 둡니다(예: ISO 27001). 국가 고유 인증 주기는 국가 가이드를 참고하고, 갱신 일정을 캘린더에 등록하세요.
...
- **벤더 인증만 믿고 사용자 책임 영역을 방치** — 벤더가 ISO 27001 등을 가지고 있어도 VPC, IAM, 암호화 설정은 사용자 책임이므로 감사에서 지적됨
...
- [ ] 인증 갱신 일정(ISO 27001 감시심사 및 국가별 인증)을 캘린더에 등록하고 관리하는가

## 참고하기

국가 규제 기관·로컬 인증 링크는 [한국](../../korea/governance/compliance/) · [미국](../../us/) · [EU](../../eu/) · [일본](../../japan/) · [싱가포르](../../singapore/) 가이드에 있습니다.
