...
:::note
GCC는 각국의 정부 클라우드 전용 센터나 공공기관 정보자원 통합 사업처럼 **정부기관이 직접 사용하는 내부용 플랫폼**입니다. 민간 벤더가 "GCC에 입점"하는 구조가 아니라, 정부기관이 AWS·Azure·GCP 위에 GovTech가 제공하는 보안·거버넌스 래퍼(wrapper)를 씌워 시스템을 운영하는 방식입니다. 민간 기업이 싱가포르 정부 대상 사업에 참여하려면 GeBIZ 조달 포털 등록과 MTCS 인증 등 별도 트랙을 거쳐야 합니다.
:::
...
- **GCC는 "정부 전용 사설 플랫폼"이지 별도의 인증 제도가 아닙니다.** 글로벌 기업이 싱가포르 정부 대상 사업(SI, SaaS 공급 등)을 검토한다면, GCC 자체에 인증받는 것이 목표가 아니라 GeBIZ 등록과 (입찰별로 요구되는) MTCS 인증 확보가 실질적인 진입 절차입니다.
