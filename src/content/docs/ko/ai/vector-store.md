...
:::note
**벡터/임베딩이 처음이라면** [AI 시작하기](../../ai/getting-started/)의 RAG 섹션을 먼저 읽어보세요. 이 문서(벡터 스토어 기초)를 읽은 뒤, 청킹·리랭킹·하이브리드 검색 등 고급 구현은 [RAG 고급 패턴](../../ai/rag-patterns/)으로 이어집니다.
:::
...
| AWS | [S3 Vectors](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-vectors.html) | S3 내구성 + 저비용 (2025.12 GA, 다수 리전 지원 — [공식 리전 목록](https://docs.aws.amazon.com/AmazonS3/latest/userguide/s3-vectors-regions-quotas.html)) |
