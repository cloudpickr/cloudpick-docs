...
- **モデル階層化** — 単純な分類は軽量モデル（GPT-5.6 Luna、Haiku）、複雑な推論は高性能モデル
...
| OCI | [Cost Report（FOCUS対応）](https://docs.oracle.com/en-us/iaas/Content/Billing/Concepts/costusagereportsoverview.htm) |
