...
:::note
멀티 계정 구조를 **실제로 구축하는 방법** — VPC 분리, 가드레일, 도입 순서, 체크리스트 — 은 [랜딩존](../../governance/landing-zone/)을 참고하세요. 이 문서는 "왜, 어떤 구조로" 나눠야 하는지 개념을 다룹니다.
:::
...
:::note
IAM 설계 상세는 [IAM 개요](../../about-cloud/iam-overview/) → [IAM 실무 설계](../../security/iam/)를 참고하세요.
:::
