...
현행 HIPAA Security Rule은 다수의 보호조치를 "필수(Required)"와 "권장(Addressable, 대안 채택 가능)"으로 구분해 왔습니다. 그러나 HHS는 2025년 1월 이 구분을 없애고 대부분의 보호조치를 의무화하는 개정안(NPRM)을 발표했습니다.
...
- 로그 최소 6년 보관(HIPAA 문서 보관 요건과 동일)
