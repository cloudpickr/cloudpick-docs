...
많은 국가의 개인정보 보호 법제는 개인정보의 국외 이전에 정보주체의 동의 또는 법적 근거를 요구하며, 금융 분야에는 더 엄격한 규제가 적용되는 경우가 많습니다. 클라우드 벤더를 선택할 때 목표 시장 국가의 리전 유무와 데이터 저장 위치를 반드시 확인해야 합니다. 국가별 리전 현황과 국외 이전 요건은 국가별 가이드를 참고하세요 — [한국](../korea/index.md) · [미국](../us/index.md) · [EU](../eu/index.md) · [일본](../japan/index.md) · [싱가포르](../singapore/index.md).
