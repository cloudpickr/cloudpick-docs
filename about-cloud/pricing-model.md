...
| 벤더 | 무료 범위 | 이후 단가 |
| --- | --- | --- |
| AWS | 월 100GB | ~$0.09~0.12/GB (리전별 상이) |
| Azure | 월 100GB | ~$0.08~0.12/GB |
| GCP | 월 200GB (+ 타 클라우드 전환 시 무료 정책) | ~$0.08~0.12/GB |
| OCI | **월 10TB** | ~$0.0085/GB |

OCI의 이그레스 무료 범위(10TB)는 타사 대비 압도적으로 넓어, 멀티클라우드 환경에서 데이터 이동이 빈번한 경우 큰 비용 차이를 만듭니다.
