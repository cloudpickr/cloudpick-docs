...
- **접근 통제와 감사 로그**: PHI 접근 최소 권한 원칙, MFA, 중앙 집중식 감사 로그(SIEM 연동) 및 장기 보관 정책을 갖춥니다. 관련 아키텍처는 [데이터 보호와 워크로드 보안](../security/data-protection.md) 및 [보안 인시던트 대응](../security/incident-response.md) 참고.
