...
- 海外企業が米国の防衛・航空宇宙プライム企業と技術データをやり取りする場合、米国国籍でない役職員は原則としてForeign Personに該当し、ITAR技術データに直接アクセスすることはできません(例: 韓国国籍の役職員)。TAA(Technical Assistance Agreement)、MLA(Manufacturing License Agreement)などのDDTC許可を事前に取得するか、米国内のUS Personで構成された別組織・子会社を通じてのみデータを取り扱う体制が必要です。
