...
AI 서비스를 프로덕션에 배포하면 전통적 보안 위협 외에 **AI 고유의 보안 위협**이 추가됩니다. [멀티클라우드 AI](../ai/multicloud-ai.md)에서 설계 시 주의사항으로 언급한 내용을 여기서 상세히 다룹니다.
...
- [ ] [EU AI Act](../governance/compliance.md) GPAI·고위험 AI 의무 해당 여부와 준수 계획을 확인했는가
