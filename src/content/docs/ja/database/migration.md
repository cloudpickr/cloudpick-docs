...
:::note[前提知識と関連ドキュメント]
DBの種類選択は、[マネージドRDB](../../database/managed-rdb/)、[NoSQL](../../database/nosql/)を先に参照してください。サーバー・アプリケーション全般の移行は[コンピュート移行](../../compute/migration/)と、大容量データの物理転送は[ストレージ移行](../../storage/migration/)と連携します。本ドキュメントは、データベース移行(スキーマ・データ・ダウンタイム最小化)に焦点を当てます。
:::
