...
- **Current operational status (as of August 2026)**: This is a transitional period: the Class A pipeline opened in early August, and Classes B/C opened at the end of August (August 31), with the first certifications beginning to appear. Per official fedramp.gov statistics, of roughly 529 total authorized services, approximately 28 have been authorized under the new FedRAMP 20x framework, while the large majority still operate under the existing Rev5 (Low/Moderate/High) framework.
