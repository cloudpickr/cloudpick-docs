---
title: "리전과 가용영역"
description: "리전, 가용영역, 엣지 로케이션의 개념과 벤더별 리전 모델, 데이터 주권 고려사항을 비교합니다."
---
...
- **지연 시간** — 사용자와 가까운 리전을 선택합니다. 주 사용자층이 있는 국가에 리전이 있다면 그 리전이 최선입니다.
...
많은 국가의 개인정보 보호 법제는 개인정보의 국외 이전에 정보주체의 동의 또는 법적 근거를 요구하며, 금융 분야에는 더 엄격한 규제가 적용되는 경우가 많습니다. 클라우드 벤더를 선택할 때 목표 시장 국가의 리전 유무와 데이터 저장 위치를 반드시 확인해야 합니다. 국가별 리전 현황과 국외 이전 요건은 국가별 가이드를 참고하세요 — [한국](../../korea/index/) · [미국](../../us/index/) · [EU](../../eu/index/) · [일본](../../japan/index/) · [싱가포르](../../singapore/index/).
