...
:::note
公共・金融の比重が大きい市場では、大手SI（例: 韓国のサムスンSDS・LG CNS・SK C&C）が大規模プロジェクトで支配的な地位を占めています。FDEはこれらの企業と**競合ではなく協業**の関係にあることが多く — SIが全体システムを構築し、FDEは自社のAI/SaaS製品の統合パートを担当する構造です。
:::
