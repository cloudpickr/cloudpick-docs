---
description: 멀티클라우드 환경에서 클라우드 간 네트워킹 방식, CIDR 설계, 연결 방식 선택 가이드를 설명합니다.
---
...
{% hint style="info" %}
이 문서는 클라우드 간 연결 방식의 개요와 CIDR 설계를 다룹니다. 트랜짓 아키텍처, 이그레스 비용, DNS 통합 등 심화 내용은 [멀티클라우드 커넥티비티](../networking/multicloud-connectivity.md)를 참고하세요.
{% endhint %}
