...
| 벤더 | BI 도구 | 특징 |
| --- | --- | --- |
| AWS | [Amazon Quick Sight](https://aws.amazon.com/quick/) | Amazon Quick 산하 BI 기능 (구 QuickSight). AI 에이전트 기반 자연어 질의, 대시보드, 분석. Quick Desktop 앱에서도 접근 가능 |
...
- [Amazon Quick 문서](https://docs.aws.amazon.com/quick/latest/userguide/what-is.html)
- [Amazon Quick Desktop 다운로드](https://aws.amazon.com/quick/download/)
