...
:::note[선행 지식 및 연결 문서]
파운데이션 모델(FM)과 어떤 모델을 고를지는 [AI 시작하기](../../ai/getting-started/)와 [AI 플랫폼과 모델 비교](../../ai/ai-ml/)를 먼저 참고하세요. 이 문서는 모델 선택이 아니라, **동일한 FM을 어디서 소비하는가** — 모델 제공사 직접(1P) vs 클라우드 플랫폼 경유(3P) — 라는 채널 선택에 초점을 둡니다.
:::
...
:::note
"같은 모델인데 왜 채널에 따라 경험이 다른가?"를 이해하는 것이 이 섹션의 목적입니다. 모델 자체의 성능 비교는 [AI 플랫폼과 모델 비교](../../ai/ai-ml/)를 참고하세요.
:::
...
:::note
**패턴 D(셀프호스팅/오픈웨이트)** 의 상세 — 대표 모델, 선택 이유, 라이선스 주의사항은 [AI 플랫폼과 모델 비교](../../ai/ai-ml/)를 참고하세요.
:::
...
제공사별 모델 목록과 접근 가능 채널은 [AI 플랫폼과 모델 비교](../../ai/ai-ml/)를 참고하세요. 한국 FM(Upstage, EXAONE 등)은 [FM 제공사 비교 (한국)](../../korea/ai/fm-providers/)를 참고하세요. 패턴별 특성 비교 표는 위 **패턴별 특성 비교** 절을 사용합니다.
...
- [한국](../../korea/) · [FM 제공사 비교 (한국)](../../korea/ai/fm-providers/)
- [미국](../../us/) · [EU](../../eu/) · [일본](../../japan/) · [싱가포르](../../singapore/)

---

## 요금제와 비용 관리

각 제공사의 라이선스 티어(Seat 플랜, API 티어), 3P 예약 용량(PTU, Provisioned Throughput), 비용 관리 도구와 패턴은 [LLM 라이선스와 비용 관리](../../ai/licensing/)에서 다룹니다.
...
- [AI 플랫폼과 모델 비교](../../ai/ai-ml/) — 벤더별 FM 카탈로그, GPU/가속기
- [멀티클라우드 AI](../../ai/multicloud-ai/) — 벤더 조합 전략
- [LLMOps](../../ai/llmops/) — 비용 추적, 평가, 운영
- [FinOps](../../governance/finops/) — 클라우드 비용 거버넌스
