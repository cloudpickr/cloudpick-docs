...
| [Amazon Q Developer (코드 스캔)](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/what-is.html) | 코드 내 시크릿·취약점 탐지 (구 CodeGuru Security). IDE 플러그인 2027.04 EOS 예정 |
