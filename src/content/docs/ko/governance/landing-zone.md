...
| **EU AI Act** (GPAI 의무 2025.08 적용; 제재 권한·제50조 투명성 2026.08 발효; 고위험 AI는 Digital Omnibus로 독립형 2027.12, 제품 내장 2028.08 연기) | 고위험 AI 시스템의 데이터 거버넌스 → 랜딩존에 AI 워크로드별 데이터 분류/접근 제어 포함 |
