...
- **Certification Class framework**: A new four-tier Class A/B/C/D framework replacing the traditional Low/Moderate/High tiers was introduced based on NTC-0004 (a policy document) published on February 25, 2026. Class C generally corresponds to the former Moderate tier and applies to systems handling non-public federal data such as CUI.
- **2026 Consolidated Rules (CR26)**: A consolidated rule finalized and effective in late June 2026 that requires authorization packages to be submitted in machine-readable format, no longer accepting PDF or Word documents. CSPs must use automation to keep their authorization packages continuously up to date whenever changes occur.
- **Current operational status (as of August 2026)**: Classes A/B/C are already operational. Per official fedramp.gov statistics, of roughly 529 total authorized services, approximately 28 have been authorized under the new FedRAMP 20x framework, while the large majority still operate under the existing Rev5 (Low/Moderate/High) framework.
