...
- 일본: [일본 개요](../japan/index.md)
- 싱가포르: [싱가포르 개요](../singapore/index.md)
{% endhint %}
...
- **한국** — 전자금융감독규정, CSAP 상·중·하, ISMS-P, N²SF C/S/O: [망분리와 네트워크 격리 (한국)](../korea/security/network-isolation.md)
- **미국** — FedRAMP, ITAR/EAR: [미국 개요](../us/index.md)
- **EU** — DORA, 데이터 주권: [EU 개요](../eu/index.md)
- **일본** — ISMAP, 가버먼트 클라우드: [일본 개요](../japan/index.md)
- **싱가포르** — MTCS, PDPA: [싱가포르 개요](../singapore/index.md)

{% hint style="info" %}
규제 체계와 무관하게, 대부분의 기관은 모든 시스템이 같은 등급이 아닙니다. 시스템별로 등급을 분류하고 격리 수준을 차등 적용하는 것이 핵심입니다. "전부 최고 등급"이나 "전부 퍼블릭"이 아니라, 혼합 구성이 현실적입니다.
{% endhint %}
...
- 한국 법령·CSAP·N²SF 링크는 [망분리와 네트워크 격리 (한국)](../korea/security/network-isolation.md)을 참고하세요.
