...
- **[PDPA（個人データ保護法）](../singapore/pdpa/)** — 国境間移転制限（Transfer Limitation Obligation）と2026年4月のガイド改正（CBPR/PRP認証の編入）、グローバル企業のASEANリージョン設計への示唆、DNC（Do Not Call）などの実務上の留意点を扱います。
