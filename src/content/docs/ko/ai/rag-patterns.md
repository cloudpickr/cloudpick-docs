...
:::note
RAG 기초(벡터 스토어·임베딩·기본 검색)는 [AI 시작하기](../../ai/getting-started/)의 RAG 섹션과 [벡터 스토어와 임베딩](../../ai/vector-store/)을 먼저 읽어보세요. 이 문서는 그 기초 위에서 **실무 품질을 높이는 고급 패턴**(청킹·리랭킹·하이브리드 검색·쿼리 확장·평가)을 다룹니다.
:::
