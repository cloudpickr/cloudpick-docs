...
- **모델 계층화** — 간단한 분류는 경량 모델(GPT-5.6 Luna, Haiku), 복잡한 추론은 고성능 모델
...
| OCI | [Tag Namespaces](https://docs.oracle.com/en-us/iaas/Content/Tagging/Tasks/managingtagsandtagnamespaces.htm), [Tag Defaults](https://docs.oracle.com/en-us/iaas/Content/Tagging/Tasks/managingtagdefaults.htm), [Cost Tracking Tags](https://docs.oracle.com/en-us/iaas/Content/Tagging/Concepts/taggingoverview.htm) | Tag Namespace로 키 관리, Tag Defaults로 Compartment 수준 자동 태깅 |
...
- **계정/구독/프로젝트 분리** — 부서별 분리는 태그보다 확실한 비용 경계 ([계정과 조직 구조](../../about-cloud/accounts-and-organizations/) 참고)
...
| OCI | [Cost Report (FOCUS 지원)](https://docs.oracle.com/en-us/iaas/Content/Billing/Concepts/costusagereportsoverview.htm) |
...
관련: [VPC와 서브넷](../../networking/vpc-subnet/)
