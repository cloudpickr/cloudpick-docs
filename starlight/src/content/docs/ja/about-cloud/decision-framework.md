...
- 主なユーザー層がいる国のリージョンを持つベンダーを優先
- グローバルサービスはエッジネットワークとリージョンカバレッジを検討
- DR時は近接リージョンまで考慮（[リージョンとアベイラビリティゾーン](../../about-cloud/regions-and-zones/)を参照）

### 3. 規制および法令遵守

- 公共・金融部門: 各国のクラウド認証・監督規制（例: 韓国のCSAP・電子金融監督規程、米国のFedRAMP）
- 個人情報: 対象市場の保護法制（例: EU GDPR）
- 詳細は[コンプライアンス](../../governance/compliance/)と国別ガイドを参照
...
- リージョンごとの価格差 — アジアなど一部のリージョンは米国リージョンに比べて10〜30%高いのが一般的
- マネージドサービスのプレミアム
