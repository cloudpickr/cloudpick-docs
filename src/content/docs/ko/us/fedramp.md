...
:::note[선행 지식 및 연결 문서]
미국 클라우드 규제 전반은 [미국 가이드](../../us/), 공동 책임 모델·규정 준수 일반 원칙은 [규정 준수](../../governance/compliance/)를 먼저 참고하세요. 이 문서는 미국 연방기관 클라우드 조달 인가 제도인 FedRAMP에 초점을 둡니다.
:::
...
| **High** | 법 집행, 응급 서비스, 금융 시스템 등 손상 시 심각한 영향 | 통제 항목 약 420여 개, 인가 난도·비용이 가장 높음 |
...
:::caution
FedRAMP 20x는 2026년 9월 현재도 진행 중인 개편으로, 정보가 빠르게 바뀝니다. 아래는 [fedramp.gov](https://www.fedramp.gov/) 공식 페이지와 공지사항을 기준으로 확인한 내용이며, 실제 도입 검토 시에는 반드시 fedramp.gov 최신 공지를 직접 재확인해야 합니다.
:::
...
- **현재 운영 상태(2026년 9월 기준)**: Class A 파이프라인이 8월 초 열렸고 Class B/C도 8월 말(8월 31일) 오픈되어 신규 20x 인증 접수가 시작된 과도기가 이어지고 있으며, fedramp.gov 공식 통계 기준 전체 약 529개 인가 서비스 중 약 28개가 신규 FedRAMP 20x 기준으로 인가를 받았고(수치는 공식 포털 집계 시점에 따라 변동), 나머지 대다수는 여전히 기존 Rev5(Low/Moderate/High) 체계로 운영되고 있습니다.
...
:::note
즉 2026년 9월 시점에서도 신규 20x 체계와 기존 Rev5 체계가 병존하는 과도기입니다. 조달 대상 기관·서비스가 어떤 체계로 인가받았는지는 [FedRAMP Marketplace](https://marketplace.fedramp.gov/)에서 개별 확인이 필요합니다.
:::
...
- **Level 3 (Expert)**: 가장 민감한 정보 대상, NIST SP 800-172 추가 통제, 정부(DIBCAC) 주도 평가

CMMC 최종 규칙(32 CFR Part 170)은 2024년 발효되었고, 계약에 반영하는 DFARS 252.204-7021 개정 규칙은 2025년 11월 10일부터 시행되었습니다. 다만 2026년 9월 현재 단계적 시행 일정(Phase 2 이후)이 검토를 위해 일시 보류된 상태로 파악되며, **정확한 시행 단계는 계약 시점에 반드시 재확인이 필요합니다.**
...
- 미 연방 SaaS 시장에 진입하려면 FedRAMP 인가가 사실상 필수 조건이며, 인가 획득에는 상당한 시간과 비용이 소요됩니다. FedRAMP 20x가 이 과정을 자동화·단축하려는 시도이지만 2026년 9월 현재 여전히 과도기이므로, 신규 진입 기업은 어떤 체계(Rev5 vs 20x)로 인가를 준비할지 fedramp.gov 최신 지침을 기준으로 판단해야 합니다.
