...
:::note
멀티클라우드 통합 관찰가능성은 [통합 관찰가능성 아키텍처](../../devops/observability/)를 참고하세요.
:::
...
:::note
SLI/SLO/SLA 개념, 에러 버짓 운영, 벤더별 SLO 도구 비교는 [SLI/SLO와 에러 버짓](../../devops/slo/)을 참고하세요.
:::
...
여러 벤더를 사용하는 환경에서의 통합 모니터링(Grafana, Datadog, OpenTelemetry 등)은 [통합 관찰가능성 아키텍처](../../devops/observability/)에서 다룹니다.
