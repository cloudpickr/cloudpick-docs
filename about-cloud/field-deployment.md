...
{% hint style="info" %}
공공·금융 대형 프로젝트에서는 현지 SI가 전체 시스템을 구축하고, FDE는 자사 AI/SaaS 통합만 담당하는 **협업** 구조가 흔합니다. 국가별 SI·조달 구도는 [한국](../korea/index.md) · [미국](../us/index.md) · [EU](../eu/index.md) · [일본](../japan/index.md) · [싱가포르](../singapore/index.md) 가이드를 참고하세요.
{% endhint %}
