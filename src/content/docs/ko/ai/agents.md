...
:::note[선행 지식 및 연결 문서]
AI가 처음이라면 [AI 시작하기](../../ai/getting-started/)와 [프롬프트 엔지니어링](../../ai/prompt-engineering/)을 먼저 읽어보세요. 이 문서는 그 위에서 동작하는 자율 에이전트의 개념·아키텍처·벤더 플랫폼에 초점을 둡니다. 조직 도입 전략은 [에이전트 도입 가이드](../../ai/agent-adoption/)를 참고하세요.
:::
